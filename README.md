rg-roam is a minimal standalone org-roam implementation, using ripgrep instead of sql. It requires no configuration -- you can use it even without a .emacs file.
